...
export const GalleryMpPage: React.FC = () => {
  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-20">
      <header>
        ...
        <p className="text-slate-500 font-medium">View all event albums and media engagement analytics.</p>
      </header>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="bg-indigo-900 rounded-[2.5rem] p-8 text-white">
          ...
          <Button fullWidth variant="outline" className="mt-8 border-white/20 text-white hover:bg-white/10 rounded-xl">Full Analytics</Button>
        </div>
      </div>
