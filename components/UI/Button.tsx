...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-[#0B3D91] text-slate-100 hover:bg-[#082b66] shadow-[0_4px_14px_0_rgba(11,61,145,0.39)]",
    secondary: "bg-[#FF9933] text-slate-100 hover:bg-[#e68a2e] shadow-[0_4px_14px_0_rgba(255,153,51,0.39)]",
    accent: "bg-[#138808] text-slate-100 hover:bg-[#0f6c06] shadow-[0_4px_14px_0_rgba(19,136,8,0.39)]",
