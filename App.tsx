...
import { ContactBulkUploadPage } from './pages/staff/ContactBulkUploadPage';
import { UploadWorkPage } from './pages/staff/UploadWorkPage';
import { TourCreationWizard } from './pages/pa/TourCreationWizard';
        ...
        <HashRouter>
          <AppLayout>
            <Routes>
              ...
              <Route path="/pa/tours/new" element={<ProtectedRoute officialOnly><TourCreationWizard /></ProtectedRoute>} />
              ...
              <Route path="/staff/contacts/bulk-upload" element={<ProtectedRoute officialOnly><ContactBulkUploadPage /></ProtectedRoute>} />
